...
#ifndef Config_File_ED_H
#define Config_File_ED_H
#include <string>  
#include <map>  
#include <iostream>  
#include <fstream>  
...
/* 
* \brief Generic Config_Fileuration Class 
* 
*/  
class Config_File 
{  
...
public:  
	...
	Config_File( std::string filename,std::string delimiter = "=",std::string comment = "*" );  
	Config_File();  
	...
	// Check whether key exists in Config_Fileuration  
	...
	// Check or change Config_Fileuration syntax  
...
template<class T>  
T Config_File::Read( const std::string& key ) const  
{  
...
template<class T>  
T Config_File::Read( const std::string& key, const T& value ) const  
{  
...
template<class T>  
bool Config_File::ReadInto( T& var, const std::string& key ) const  
{  
...
template<class T>  
bool Config_File::ReadInto( T& var, const std::string& key, const T& value ) const  
{  
	// Get the value corresponding to key and store in var  
	// Return true if key is found  
...
template<class T>  
void Config_File::Add( const std::string& in_key, const T& value )  
{  
